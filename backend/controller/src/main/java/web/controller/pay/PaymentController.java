...
public class PaymentController {
    ...
    @GetMapping("/order")
    public void pagePay(PayDTO payDTO,HttpServletResponse response) throws Exception {
    ...
    public AlipayTradeQueryResponse query(@RequestParam String outTradeNo) throws Exception {
